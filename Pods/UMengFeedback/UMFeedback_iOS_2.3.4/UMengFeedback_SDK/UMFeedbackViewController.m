...
//                                   lineBreakMode:NSLineBreakByWordWrapping];
        ...
        CGRect labelRect = [content boundingRectWithSize:CGSizeMake(self.mTableView.frame.size.width - 40, MAXFLOAT) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName: [UIFont systemFontOfSize: 14.0f], NSParagraphStyleAttributeName: paragraphStyle.copy} context:nil];
